...
function Womenspage() {
    ...
    const Womenproducts = useSelector((state) => state.Products[0].WomensAttire[0])
            ...
            <div className="col-md-12 mx-auto">
                ...
                <div className="parent" id="parent"  >
                    <div className="shirt" data-aos="fade-up"  >
                        {
                            Womenproducts.Wshirts.map((element, index) => (
                    ...
                    <div className="shirt" data-aos="fade-up">
                        {
                            Womenproducts.Wtshirts.map((element, index) => (
                                <Card element={element} key={index} imgsrc={element.imgscr} price={element.price} title={element.title} />
                            ))
                        }
                    </div>
                    ...
                    <div className="shirt" data-aos="fade-up" >
                        {
                            Womenproducts.Wpolos.map((element, index) => (
                                <Card element={element} key={index} imgsrc={element.imgscr} price={element.price} title={element.title} />
                            ))
                        }
                    </div>
